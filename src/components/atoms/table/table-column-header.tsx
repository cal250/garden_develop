...
// @internal
export interface TableColumnHeaderProps<T = object>
...
const TableColumnHeader = forwardRef<"th", TableColumnHeaderProps>(
  (props, ref) => {
    ...
    return (
      ...
      >
        {hideHeader ? (
          <VisuallyHidden>{node.rendered}</VisuallyHidden>
        ) : (
          node.rendered
        )}
        {allowsSorting && (
