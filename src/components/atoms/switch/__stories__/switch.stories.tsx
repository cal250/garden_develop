...
import { SunIcon as SunFilledIcon, MoonIcon as MoonFilledIcon } from '@/components/atoms/icons'
import { clsx } from '@nextui-org/shared-utils'
import { useForm } from 'react-hook-form'

import { Switch, SwitchProps, SwitchThumbIconProps, useSwitch } from '../index'

export default {
  name: 'Components/Atoms/Switch',
  component: Switch,
  argTypes: {
    color: {
      control: {
...
const CustomWithHooksTemplate = (args: SwitchProps) => {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <p className="select-none text-default-500">Lights: {isSelected ? 'on' : 'off'}</p>
    </div>
  )
}
