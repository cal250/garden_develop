...
const BuilderIntentionClientPage = ({ specialEco }: props) => {
        ...
        >
          <section className="h-full w-full flex flex-col gap-10 md:gap-[77px] items-center justify-between relative">
            ...
            <section className="w-full mt-[70px] md:mt-[80px] flex flex-col items-center justify-center gap-4 md:gap-5">
              <div className="w-full max-w-[522px] px-4 md:px-0">
                <input
                  type="text"
                  value={intention}
                  onChange={(e) => setIntention(e.target.value)}
                  placeholder="| my intention is ..."
                  className="w-full text-center placeholder:text-center text-color-13/80 placeholder:text-color-13/80 text-base md:text-lg font-extrabold bg-transparent focus:outline-none py-2"
                />
...
export default BuilderIntentionClientPage
