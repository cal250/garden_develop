...
export const NewVideoPlayer: React.FC<VideoPlayerProps> = ({ onClose }) => {
  const width = useWindowWidth()
  return (
    <DesignContextProvider stroke="#FFF3D1" strokeWidth={10}>
      <div
      ...
      >
        <AnimatePresence>
          ...
          ></motion.div>
          <Rectagon
            className="z-50 h-[500px] sm:h-[650px] md:h-[728px] w-[1273px] bg-black p-[30px] sm:p-10 md:p-[50px]"
            as={motion.div}
          ...
          >
            {/* <Button
              className="absolute right-[30px] top-0 aspect-square h-[50px] w-[50px] md:h-[80px] md:w-[80px] -translate-y-1/2 bg-[#FFF3D1]"
              onPress={onClose}
              strokeWidth={0}
            ...
            >
              <CloseIcon
                className="h-5 md:h-[30px] w-5 md:w-[30px] text-[#9D68A0]"
                strokeWidth={5}
              />
            </Button> */}
            <RegularOctagon
              ...
              polygon={RegularPolygon}
              sides={8}
              className="absolute right-[15px] sm:right-[30px] top-0 aspect-square h-[50px] w-[50px] md:h-[80px] md:w-[80px] -translate-y-1/2 bg-[#FFF3D1]"
            >
              <button
                onClick={onClose}
