...
export const NameStoryGlowOctagon: React.FC<NameStoryGlowOctagonProps> = ({
  octagonData,
  userAvatar,
  ecoIcon,
}) => {
      ...
      segments: [
        ...
        },
        {
          content: ecoIcon ? (
            ...
            <FlowerIcon className="h-6 sm:h-8 md:h-10 w-6 sm:w-8 md:w-10" />
          ),
        },
      ],
    }))
...
interface NameStoryGlowOctagonProps {
  octagonData: any[]
  userAvatar: string
  ecoIcon: string | null
}
