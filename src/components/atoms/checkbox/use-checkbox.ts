import type { CheckboxSlots, CheckboxVariantProps, SlotsToClasses } from '@nextui-org/theme'
import { checkbox } from '@nextui-org/theme'
import type { AriaCheckboxProps } from '@react-types/checkbox'
import type { HTMLNextUIProps, PropGetter } from '@nextui-org/system'
import { useProviderContext } from '@nextui-org/system'
import React, { ReactNode, Ref, useCallback, useId, useMemo, useRef } from 'react'
import { useToggleState } from '@react-stately/toggle'
import { useCallbackRef } from '@nextui-org/use-callback-ref'
import { useHover } from '@react-aria/interactions'
import { useFocusRing } from '@react-aria/focus'
import { chain, mergeProps } from '@react-aria/utils'
import { __DEV__, clsx, dataAttr, safeAriaLabel, warn } from '@nextui-org/shared-utils'
import {
...
interface Props extends Omit<HTMLNextUIProps<'input'>, keyof CheckboxVariantProps> {
  ...
  wrapperComponent?: (props: any) => ReactNode
  /**
