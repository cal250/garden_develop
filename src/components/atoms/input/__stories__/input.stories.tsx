...
const StartAndEndContentTemplate = (args: InputProps) => (
  <div className="flex w-full max-w-xs flex-col items-end gap-4">
    <Input
      ...
      placeholder="nextui"
      startContent={
        <MailIcon className="pointer-events-none flex-shrink-0 text-xl text-default-400" />
      }
    />
    <Input
      {...args}
...
const WithReactHookFormTemplate = (args: InputProps) => {
  ...
  return (
    <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
      <Input {...args} isClearable label="With default value" {...register('withDefaultValue')} />
