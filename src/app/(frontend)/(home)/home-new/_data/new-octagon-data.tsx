...
export const newOctagonData: Array<WedgeData> = [
  'tending',
  '',
  '',
  'weaves',
  ...
  className: index === 1 || index === 2 ? 'bg-[#65438A]' : index === 7 ? 'bg-color-2' : '',
  ...
  segments: [
    ...
    {
      content: flower ? <FlowerIcon className="h-8 w-8" active={index === 7} /> : <div />,
    },
  ],
}))
