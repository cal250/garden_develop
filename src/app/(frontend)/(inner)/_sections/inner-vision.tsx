...
export const InnerVision: React.FC<InnerVisionProps> = () => {
  ...
  return (
    <DesignContextProvider stroke="#90BE6B" strokeWidth={4}>
      <BodyCard
        ...
        headerCardProps={{
          ...
          classNames: {
            ...
            title: 'text-[22px] leading-[100%] sm:text-[28px] md:text-[36px] font-black',
            outerTitle: 'text-[22px] leading-[100%] sm:text-[28px] md:text-[36px] font-black',
          },
        }}
        style={{
      ...
      >
        <p className="max-w-[558px] pt-14 md:pt-20 px-3 text-center text-[18px] sm:text-[20px] md:text-[22px] font-bold">
          Welcome to ⟨inner⟩Vision, an enchanted realm where your emotions bloom into augmented
          landscapes and your curiosity guides the game. Sculpt meaning, plant wisdom, and witness
          your feelings take form as forests, rivers, and creatures of light. 
        </p>
