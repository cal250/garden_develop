...
import { MouseEventHandler, ReactNode, JSX } from "react";
import { HTMLMotionProps } from "framer-motion";
import { PolymorphicPolygonProps } from "@/components/utils/react/polymorphism";
...
const AccordionItemBase = BaseItem as <T extends As>(
  props: PolymorphicPolygonProps<T, AccordionItemBaseProps>,
) => JSX.Element;
